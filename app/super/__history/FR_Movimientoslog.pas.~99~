...
begin
    ZQLogs.Close;
    ZQLogs.SQL.Clear;
    ZQLogs.SQL.Add('SELECT movimiento AS tipo, movimiento_detalles AS movimiento, fecha FROM empleado_movimiento WHERE empleado=:emp ORDER BY 3 DESC'); //WHERE empleado = "'+FPrincipal.Label2.Caption+'"
