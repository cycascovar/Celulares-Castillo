...
begin
    try
        ...
        guardar.FileName :=getSucursal+'_'+cleanSlashes(Date());
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    FieldByName('Movimiento').AsString+'            '+
                    FieldByName('Empleado').AsString+'            '+
                    FieldByName('Sucursal').AsString+'            '+
                    FieldByName('Fecha').AsString+'            '+#13);
                    barra.StepIt;
                    Next;
                end;
            end;
...
begin
    FRMovimientoslog.QuickRep1.Prepare;
    FRMovimientoslog.QuickRep1.PrinterSetup;
    FRMovimientosLog.QuickRep1.Print;
end;
