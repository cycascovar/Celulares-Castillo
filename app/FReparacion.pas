...
type
  ...
  private
    ...
    ZQTemp : TZQuery;
    procedure loadRepairingPhones(); overload;
    procedure loadRepairingPhones(_date : TDateTimePicker); overload;
  public
    { Public declarations }
  end;
...
begin
    ...
    setTitleWindow(self,'Equipos en reparación - Celulares "Chapulh", (sucursal '+getSucursal+')');

    FormatSettings.ShortDateFormat := 'yyyy-mm-dd';

    {reemplazar por vista}
    ZQReparaciones.Close;
    ZQReparaciones.SQL.Clear;
...
procedure TFReparaciones.loadRepairingPhones;
begin
//
end;

procedure TFReparaciones.loadRepairingPhones(_date: TDateTimePicker);
begin
//
end;
